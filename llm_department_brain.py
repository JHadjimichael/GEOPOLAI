...
class llm_econ_department_brain():
    ...
    def priority(balance, population_level, income_level, food_level, wm_level, num_enemies, choice_1, choice_2, choice_3):
        ...
        outro = f"That is all the information currently available. Using your expertise, and only stating either '1', '2', or '3', the option number you would pick if you had to would be:"
